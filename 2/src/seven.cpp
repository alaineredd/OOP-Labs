...
namespace Seven {
    ...
    Seven::Seven(size_t size, unsigned char number) : data_(0) {
        if(size == 0) {
    ...
    Seven::Seven(const std::string& s) : data_(0) {
        if(s.size() == 0) {
            throw std::invalid_argument("zerolength");
        }
    ...
    Seven::Seven(const std::initializer_list<unsigned char>& list) : data_(0) {
        if (list.size() == 0) {
            throw std::invalid_argument("zerolength");
        }
